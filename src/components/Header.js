...
const Header = () => {
    ...
    return(
        <nav className="bg-gray-50 text-gray-700 dark:bg-gray-800 dark:text-gray-200 py-6 lg:py-0 border-b-2 dark:border-gray-700">
            <div className="flex flex-row mx-4 lg:mx-32 content-center">
                ...
                <div className="hidden lg:flex justify-center mx-auto py-2">
                    <div className="transition-all duration-200 flex rounded-full bg-gray-100 dark:bg-gray-700 shadow focus-within:ring-2 focus-within:ring-primary my-4 xl:w-96">
                        <input autoComplete="off" onKeyDown={handleKeypress} onChange={(e) => setSearch(e.target.value)} className="bg-transparent outline-none py-3 px-6 w-full" type="search" name="words" id="words" placeholder="English, Japanese, Kanji, Words" />
