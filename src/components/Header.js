            ...
            <div className="flex flex-row mx-4 lg:mx-32 content-center">
                ...
                <div className="hidden lg:flex justify-center mx-auto py-2">
                    <div className="flex rounded-full dark:bg-gray-700 shadow focus-within:ring-2 focus-within:ring-primary my-4">
                        <input onChange={(e) => setSearch(e.target.value)} className="bg-transparent outline-none py-3 px-6" type="search" name="words" id="words" placeholder="Search" />
                        <Link to={"/search?words="+search} className="transition-color duration-150 p-3 rounded-r-full bg-gray-100 dark:bg-gray-600 dark:border-gray-500 hover:text-white hover:bg-primary dark:hover:bg-primary ">
