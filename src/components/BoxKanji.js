...
const BoxKanji = (props) =>{
    ...
    return(
        <li className="box-border col-span-1 rounded-md bg-gray-50 dark:bg-gray-800 p-2 lg:py-4 shadow-md dark:shadow-md dark:hover:bg-opacity-80 hover:shadow-none hover:cursor-pointer">
