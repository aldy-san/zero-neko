    ...
    return(
        <nav className="bg-gray-50 dark:bg-gray-800 text-gray-700  dark:text-gray-200 py-6 lg:py-0 border-b-2 dark:border-gray-700">
            <div className="flex flex-row mx-4 lg:mx-32 content-center">
                <a className="content-center hidden xl:flex" href="/"><img src={(theme !== "dark" ? logo : logoWhite)} alt="logo-full" width="180" height="0" /></a>
                <a className="flex content-center mx-auto xl:hidden" href="/"><img src={(theme !== "dark" ? logoIcon : logoIconWhite)} alt="logo-full" width="35" height="0"/></a>
