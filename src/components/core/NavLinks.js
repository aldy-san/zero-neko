...
const NavLinks = (props) => {
    ...
    return(
        <li className="relative group" onClick={() => setShow(!show)}>
            ...
            className={(props.nav.type !== "dropdown" ? "flex" : "hidden ")+"transition-all delay-150 flex text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200 font-semibold text-base lg:text-lg tracking-wider"}
