...
const Kana = () => {
    return(
        <div className="flex flex-col text-center lg:mx-36 space-y-6 my-20">
            <h1 className="flex flex-col text-5xl mb-4">
                <div className="mb-4">
                    <div className="flex justify-center mx-auto fill-current transform scale-150">
            ...
            <div className="flex flex-col space-y-6">
                <ul className="flex flex-col space-y-6">
                    <li className="text-gray-600 dark:text-gray-300 bg-gray-200 hover:bg-gray-300 dark:bg-gray-700 dark:hover:bg-gray-600 text-2xl mx-auto py-4 px-7 rounded-full">
                ...
                <span className="text-xl max-w-prose">More Games Coming Soon</span>
            </div>
        </div>
    )
}
