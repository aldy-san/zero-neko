    ...
    return(
        <div className="flex flex-col text-center lg:mx-36">
            ...
            <div className="flex flex-col space-y-6">
                <ul className="flex flex-col space-y-4 mx-8">
                    <li className="text-gray-600 dark:text-gray-300 bg-gray-200 hover:bg-gray-300 dark:bg-gray-700 dark:hover:bg-gray-600 text-xl py-3 w-full rounded-lg cursor-pointer">
