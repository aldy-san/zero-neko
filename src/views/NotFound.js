...
const NotFound = () => {
    return(
        <div className="flex flex-col mx-8 lg:mx-32 lg:mr-52 my-6 lg:my-12 space-y-4 lg:space-y-8">
            ...
            <a href="/" className="transition-all delay-150 flex self-start rounded-full font-medium mx-auto mt-4 lg:mt-8 px-6 py-3 lg:px-6 lg:py-4 lg:text-xl bg-gray-200 hover:bg-primary hover:text-white dark:bg-gray-700 dark:bg-opacity-80 dark:hover:bg-primary">
                Back to Homepage
            </a>
        </div>
    )
