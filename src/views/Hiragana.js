    ...
    return(
        <>
            <div className="text-center lg:mx-36">
                <h1 className="text-6xl mt-8 mb-12 text-left"><span className="font-black rounded-full">あ</span> Hiragana</h1>
                    ...
                    <ul className="grid grid-cols-5 auto-rows-min grid-span-1 gap-2 lg:gap-4 lg:p-4">
                        {
                            hiragana.map((hira, index) => {
                                ...
                                return(
                                    <li className={"box-border transition-all delay-75 grid-span-1 col-start-"+hira.start+" rounded-md bg-gray-50 dark:bg-gray-700 box-content p-4 shadow-md dark:shadow-mdWhite dark:hover:shadow-none hover:shadow-none"} key={index}>
