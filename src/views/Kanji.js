        ...
        <div className="relative text-center lg:mx-36">
            ...
            <div className="flex py-4 px-1 ">
                <div className="flex flex-col">
                    <span className="text-sm text-white pb-3 pl-1 pt-0 text-left">{'Searched "'+filter.split("/")[1]+'"'}</span>
                ...
                <div className="ml-auto mt-auto">
                    <button onClick={() => {setModal(true)}} className="flex bg-gray-50 dark:bg-gray-600 dark:hover:bg-gray-700 rounded-lg shadow hover:bg-gray-100 text-lg py-3 px-6 cursor-pointer">
                        <svg width="24" height="24" fill="none" viewBox="0 0 24 24">
