        ...
        <div className="mx-8 lg:mx-32 lg:mr-52 h-96">
            <div className="relative flex flex-col lg:flex-row lg:mt-20 p-2 lg:p-8 rounded-lg">
                ...
                <div className="flex flex-col content-start text-center lg:text-left">
                    ...
                    <a href="/" className="transition-all delay-150 flex self-start rounded-full font-medium mx-auto lg:mx-0 mt-4 lg:mt-8 px-4 py-2 lg:px-6 lg:py-4 lg:text-xl bg-gray-200 hover:bg-gray-300 dark:bg-gray-700 dark:bg-opacity-80 dark:hover:bg-gray-600">
                        Let's Start
